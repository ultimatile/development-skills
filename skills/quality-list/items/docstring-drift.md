...
Whether a statement needs a qualification the diff's new text introduced is `paired-artifact-drift`'s concern (its **Qualification completeness** sweep); this procedure owns the claim-vs-behavior axis.
